drop database if exists callcenter2020;
...
('jsmith','Jhon Smith',1001,'1001.png',sha1('abc123')),
('mjones','Mary Jones',1002,'1002.png',sha1('mary123')),
('sjhonson','Steve Jhonson',1003,'1003.png',sha1('steve1986'));

select * from users;
select * from users where id = 'mjones' and password = sha1('mary123');